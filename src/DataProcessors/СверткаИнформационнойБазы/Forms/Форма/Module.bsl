...
Процедура ИзменитьДатуНачалаВыгрузкиДокументов(Отказ)
	...
	Запрос = Новый Запрос("
			...
			|ИЗ
			|	ПланОбмена.ОбменУправлениеТорговлейРозница КАК РТ1
			|ГДЕ
			...
			|	БП2.ПометкаУдаления
			|ИЗ
			|	ПланОбмена.ОбменУправлениеТорговлей31Бухгалтерия20 КАК БП2
			|ГДЕ
	...
	Запрос.УстановитьПараметр("ЭтотУзелРТ1",     ПланыОбмена.ОбменУправлениеТорговлейРозница.ЭтотУзел());
	Запрос.УстановитьПараметр("ЭтотУзелБП2",     ПланыОбмена.ОбменУправлениеТорговлей31Бухгалтерия20.ЭтотУзел());
