...
Процедура ОбновитьСоставЭлементовФормы(ТекстПредупреждения = "")
	...
	Иначе
		...
		Если СвойстваВладельца.ЭтоДополнительноеСведение <> Истина Тогда
			ШаблонУточнения = НСтр("ru='Список значений общий с реквизитом ""%1"" набора ""%2""';uk='Список значень спільний з реквізитом ""%1"" набору ""%2""'");
		Иначе
			ШаблонУточнения = НСтр("ru='Список значений общий со сведением ""%1"" набора ""%2""';uk='Список значень спільний з відомістю ""%1"" набору ""%2""'");
		КонецЕсли;
