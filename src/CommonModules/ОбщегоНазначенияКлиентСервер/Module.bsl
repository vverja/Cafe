...
Процедура ПроверитьПараметр(Знач ИмяПроцедурыИлиФункции, Знач ИмяПараметра, Знач ЗначениеПараметра, 
	...
	Проверить(ТипЗнч(ИмяПроцедурыИлиФункции) = Тип("Строка"), 
		НСтр("ru='Недопустимо значение параметра ИмяПроцедурыИлиФункции';uk='Неприпустиме значення параметру ИмяПроцедурыИлиФункции'"), Контекст);
	Проверить(ТипЗнч(ИмяПараметра) = Тип("Строка"), 
		НСтр("ru='Недопустимо значение параметра ИмяПараметра';uk='Неприпустиме значення параметру ИмяПараметра'"), Контекст);
		
	ЭтоОписаниеТипов = ТипЗнч(ОжидаемыеТипы) = Тип("ОписаниеТипов");
	Проверить(ЭтоОписаниеТипов Или ТипЗнч(ОжидаемыеТипы) = Тип("Тип"), 
		НСтр("ru='Недопустимо значение параметра ОжидаемыеТипы';uk='Неприпустиме значення параметру ОжидаемыеТипы'"), Контекст);
