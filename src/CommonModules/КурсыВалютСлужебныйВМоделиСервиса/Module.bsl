		...
		Попытка
			...
			Пока ВыборкаВалюты.Следующий() Цикл
				...
				Иначе
					...
					ИмяСобытия = НСтр("ru='Поставляемые данные.Отмена загрузки курсов валюты';uk='Дані, що постачаються.Скасування завантаження курсів валют'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
