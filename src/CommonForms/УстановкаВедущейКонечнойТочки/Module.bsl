...
Процедура Установить(Команда)
	...
	Состояние(НСтр("ru='Выполняется установка ведущей конечной точки. Пожалуйста, подождите...';uk='Виконується встановлення ведучою кінцевої точки. Будь ласка, зачекайте...'"));
