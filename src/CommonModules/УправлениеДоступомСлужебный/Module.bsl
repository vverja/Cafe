...
Процедура ПриИзмененииОграниченияДоступаНаУровнеЗаписей(ОграничениеДоступаНаУровнеЗаписейВключено) Экспорт
	...
	Если ОграничениеДоступаНаУровнеЗаписейВключено Тогда
		...
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ru='Начато заполнение данных для ограничения доступа.';uk='Розпочато заповнення даних для обмеження доступу.'"),
			РежимТранзакцииЗаписиЖурналаРегистрации.Транзакционная);
...
Функция СвойстваПрофиляОткрытиеВнешнихОтчетовИОбработок()
	...
	Результат.Наименование = НСтр("ru='Открытие внешних отчетов и обработок';uk='Відкриття зовнішніх звітів та обробок'",Метаданные.ОсновнойЯзык.КодЯзыка);
	Результат.Комментарий  = НСтр("ru='Предоставляет право открытия внешних отчетов и обработок из меню ""Файл - Открыть"".
        |Состав ролей профиля не рекомендуется изменять.'
        |;uk='Надає право відкриття зовнішніх звітів та обробок з меню ""Файл - Відкрити"".
        |Склад ролей профілю не рекомендується змінювати.'",Метаданные.ОсновнойЯзык.КодЯзыка);
