...
Процедура ВыполнитьСопоставлениеОбъектов(Отказ)
	...
	Попытка
		...
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыМетода,
			НСтр("ru='Сопоставление объектов';uk='Співставлення об''єктів'"));
	...
	Исключение
		Отказ = Истина;
		ЗаписьЖурналаРегистрации(НСтр("ru='Помощник сопоставления объектов.Анализ данных';uk='Помічник співставлення об''єктів.Аналіз даних'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
