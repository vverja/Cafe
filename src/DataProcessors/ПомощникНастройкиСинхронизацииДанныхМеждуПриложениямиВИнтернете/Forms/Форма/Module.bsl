...
Процедура ВыполнитьАвтоматическоеСопоставлениеДанных(Отказ)
	...
	Попытка
		...
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыМетода,
			НСтр("ru='Настройка синхронизации данных между приложениями в сети Интернет (автоматическое сопоставление данных)';uk='Настройка синхронізації даних між прикладними програмами в мережі Інтернет (автоматичне співставлення даних)'"));
...
Процедура ПолучитьСтатистикуСопоставления(Отказ)
	...
	Попытка
		...
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыМетода,
			НСтр("ru='Настройка синхронизации данных между приложениями в сети Интернет (получение статистики сопоставления)';uk='Настройка синхронізації даних між прикладними програмами в мережі Інтернет (одержання статистики співставлення)'"));
