...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='Отправка SMS на телефон';uk='Відправлення SMS на телефон'") + " " + НомераПолучателей;
КонецПроцедуры
...
Функция СтатусДоставки(ИдентификаторСообщения)
	...
	СтатусыДоставки.Вставить("Отправляется", НСтр("ru='Отправка сообщения...';uk='Відправлення повідомлення...'"));
