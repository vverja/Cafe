...
Процедура ВыполнитьАвтоматическоеСопоставлениеДанных(Параметры, АдресВременногоХранилища) Экспорт
	...
	Если Отказ Тогда
		ВызватьИсключение СтрШаблон(НСтр("ru='Возникли ошибки при выполнении автоматического сопоставления данных, полученных от корреспондента ""%1"".';uk='Виникли помилки при виконанні автоматичного співставлення даних, отриманих від кореспондента ""%1"".'"),
			Строка(Корреспондент));
	КонецЕсли;
