...
Процедура ВыполнитьСопоставлениеОбъектов(Отказ)
	...
	Попытка
		...
		Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыМетода,
			НСтр("ru='Автоматическое сопоставление объектов';uk='Автоматичне співставлених об''єктів'"));
	...
	Исключение
		Отказ = Истина;
		ЗаписьЖурналаРегистрации(НСтр("ru='Помощник сопоставления объектов.Автоматическое сопоставление';uk='Помічник співставлення об''єктів.Автоматичне співставлення'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
