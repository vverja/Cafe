...
Функция ПроверитьПодключениеКСерверуИсходящейПочты(Профиль, АдресЭлектроннойПочты)
	...
	Тема = НСтр("ru='Тестовое сообщение конфигурации BAS';uk='Тестове повідомлення конфігурації BAS'");
	Тело = НСтр("ru='Это сообщение отправлено подсистемой электронной почты конфигурации BAS';uk='Це повідомлення надіслано підсистемою електронної пошти конфігурації BAS'");
	ИмяОтправителяПисем = НСтр("ru='Конфигурация BAS';uk='Конфігурація BAS'");
