...
Процедура ПроверитьСистемнаяУчетнаяЗаписьНастроена()
	...
	Если Не Результат Тогда
		ВызватьИсключение НСтр("ru='Системная учетная запись электронной почты не настроена для отправки.';uk='Системний обліковий запис електронної пошти не налаштований для відправки.'");
	КонецЕсли;
