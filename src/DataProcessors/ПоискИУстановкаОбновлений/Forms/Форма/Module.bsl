...
Процедура НадписьКакОформитьПодпискуИТСНажатие(Элемент)
	ОбновлениеКонфигурацииКлиент.ОткрытьВебСтраницу("http://its.bas-soft.eu/db/aboutitsu#content:20:hdoc");
КонецПроцедуры
...
Процедура НадписьПодробнееОбИТСОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ОбновлениеКонфигурацииКлиент.ОткрытьВебСтраницу("http://its.bas-soft.eu/about");
КонецПроцедуры
