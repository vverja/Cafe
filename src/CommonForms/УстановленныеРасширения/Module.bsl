...
Процедура УдалитьРасширения(ВыделенныеСтроки)
	...
	Если ВыделенныеСтроки.Количество() > 1 Тогда
		ТекстВопроса = НСтр("ru='Вы уверены, что хотите удалить выделенные расширения?';uk='Ви впевнені, що хочете вилучити виділені розширення?'");
	Иначе
		ТекстВопроса = НСтр("ru='Вы уверены, что хотите удалить расширение?';uk='Ви впевнені, що хочете вилучити розширення?'");
	КонецЕсли;
...
Процедура ЗагрузитьРасширениеПослеУстановкиРасширения(РасширениеПодключено, Контекст) Экспорт
	...
	Если РасширениеПодключено Тогда
		...
		Диалог.Фильтр = НСтр("ru='Расширение конфигурации';uk='Розширення конфігурації'")+ " (*.cfe)|*.cfe";
		Диалог.МножественныйВыбор = Контекст.МножественныйВыбор;
		Диалог.ПроверятьСуществованиеФайла = Истина;                     
		Диалог.Заголовок = НСтр("ru='Выберите файл расширения конфигурации';uk='Оберіть файл розширення конфігурації'");
