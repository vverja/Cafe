...
// Возвращает список объектов метаданных, имеющих свойства, для которых используется тип
// ХранилищеЗначения.
//
// Возвращаемое значение:
//  ФиксированноеСоответствие:
//    * Ключ - Строка, полное имя объекта метаданных,
//    * Значение - Массив(Структура), поля структуры:
//       * ИмяРеквизита - Строка, имя свойства,
//       * ИмяТабличнойЧасти - Строка, имя табличной части (используется только для реквизитов табличных
//          частей объектов).
//
...
//	СписокМетаданных - см. возвращаемое значение "СписокМетаданныхСХранилищемЗначения"
//
...
Процедура ДобавитьСсылочныйТипВСписокМетаданных(Метаданные, СписокМетаданных)
	...
	ВставитьМетаданноеСХранилищемЗначенияВСоответствие(Метаданные.ПолноеИмя(), СписокМетаданных, МассивСтруктур);
...
Процедура ДобавитьРегистрВТаблицуМетаданных(Знач МетаданныеОбъекта, Знач СписокМетаданных)
	...
	ВставитьМетаданноеСХранилищемЗначенияВСоответствие(МетаданныеОбъекта.ПолноеИмя(), СписокМетаданных, МассивСтруктур);
	
КонецПроцедуры

// Формирует массив структур с реквизитами, хранящими хранилиза значений.
//
// Параметры:
...
// Добавляет в список метаданных метданное в реквизите которого есть хранилище значений.
//
// Параметры:
//	ПолноеИмяМетаданных - Строка - имя метаданных.
//	СписокМетаданных - см. возвращаемое значение "СписокМетаданныхСХранилищемЗначения"
//	МассивСтруктур - Массив - массив структур: см. "СтруктураРеквизитовСХранилищемЗначений"
//
Процедура ВставитьМетаданноеСХранилищемЗначенияВСоответствие(ПолноеИмяМетаданных, СписокМетаданных, МассивСтруктур)
